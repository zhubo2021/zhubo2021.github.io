  ...
  methods: {
    ...
    getData() {
      try {
        ...
        // chart1
        this.axiosRquest("zs_kk_minute_stat_rt_ksl"),
        // chart2
        this.axiosRquest("zs_kk_minute_stat_rt_ht"),
        // chart3
        this.axiosRquest("zs_path_min_pass_time_stat_rt")]).then(_axios_js__WEBPACK_IMPORTED_MODULE_4__["default"].spread((res1, res2, res3, res4, res5, res6, res7, res8, res9, res10, res11) => {
